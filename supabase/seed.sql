...
('strength', $json${
  "items": [
    {
      "title": "행사 진행 경험",
      "description": "다양한 행사에서 모델 및 MC 경험을 바탕으로 관객과 자연스럽게 소통할 수 있습니다."
    },
    {
      "title": "콘텐츠 제작",
      "description": "촬영부터 편집, 업로드까지 직접 진행하여 행사 이후에도 SNS 홍보 콘텐츠 제작이 가능합니다."
    },
    {
      "title": "다양한 캐릭터 소화",
      "description": "귀여운 캐릭터부터 성숙한 캐릭터까지 폭넓은 콘셉트를 표현합니다."
    },
    {
      "title": "서브컬처 이해도",
      "description": "애니메이션·게임을 오래 즐겨온 덕후로서 작품과 캐릭터에 대한 이해도가 높습니다."
    },
    {
      "title": "책임감 있는 행사 참여",
      "description": "시간 약속과 행사 운영을 중요하게 생각하며 관계자들과 원활하게 소통합니다."
    }
  ],
  "heading": "STRENGTH"
}$json$::jsonb),
...
('sns', $json${
  ...
  "platforms": [
    {
      "url": "https://www.youtube.com/@nanary000",
      "name": "YouTube",
      "stats": [
        {
          "label": "구독자",
    ...
    {
      "url": "https://www.instagram.com/cos_nanary/",
      "name": "Instagram",
      "stats": [
        {
          "label": "팔로워",
    ...
    {
      "url": "https://chzzk.naver.com/0af0472d401993d11c25adc611856536",
      "name": "Chzzk",
      "stats": [
        {
          "label": "활동",
...
('contact', $json${
  "links": [
    {
      "href": "https://www.youtube.com/@nanary000",
      "label": "유튜브"
    },
    {
      "href": "https://www.instagram.com/cos_nanary/",
      "label": "인스타그램"
    },
    {
      "href": "https://x.com/nanary000",
      "label": "X"
    },
    {
      "href": "mailto:nanary000@naver.com",
      "label": "이메일"
    }
  ],
