...
- [x] **Step 1: 기존 테스트 파일에 신규 테스트를 추가해 실패 상태로 만든다**
...
- [x] **Step 3: PhotoModal.jsx를 다중 사진 지원하도록 구현**
...
- [x] **Step 1: PhotoModal 렌더링에 key prop 추가**
...
- [x] **Step 3: ListField.jsx에 reorderable 구현**
...
- [x] **Step 5: 전체 테스트 스위트 실행해서 다른 ListField 사용처(카테고리, 링크 등)가 깨지지 않았는지 확인**
...
- [x] **Step 3: 수동 브라우저 검증 (Playwright 또는 `npm run preview`)**
