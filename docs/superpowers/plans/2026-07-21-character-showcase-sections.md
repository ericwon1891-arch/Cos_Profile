...
- [ ] **Step 3: `CharacterSectionBlock.jsx` 작성**
...
- [ ] **Step 3: `CharactersSection.jsx`를 컨테이너로 교체**
...
- [ ] **Step 1: `CharactersForm.jsx` 전체 교체**
...
- [ ] **Step 1: `supabase/update-characters-sections.sql` 작성**
...
- [ ] **Step 2: 커밋 (SQL 파일만 — 아직 운영 DB에는 실행하지 않음)**
...
- [ ] **Step 4: 마이그레이션 실행 여부 확인 (사용자 승인 필요)**
